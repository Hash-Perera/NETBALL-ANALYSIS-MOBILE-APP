...
export default function AttackAnalyzingTopPlayers({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASEURL}attackanalysis/top-players`, {
        method: 'POST',
        headers: {
      ...
      <View style={styles.playerContainer}>
        ...
        <View style={styles.playerInfo}>
          ...
          <Text style={styles.playerPercentage}>
            Percentage: {item.attackAnalysisData?.overall?.toFixed(2) || 'N/A'}%
          </Text>
        </View>
      </View>
  ...
  return (
   <View style={styles.container}>
         <View style={styles.header}>
           ...
           <Text style={styles.headerText}>Attack Top Players</Text>
         </View>
