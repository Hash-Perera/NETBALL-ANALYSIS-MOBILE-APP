...
export default function DefenceAnalyzingTopPlayers({ navigation }) {
 const [count, setCount] = useState('');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASEURL}defenceanalysis/top-players`, {
        method: 'POST',
        headers: {
      ...
      <View style={styles.playerContainer}>
        ...
        <View style={styles.playerInfo}>
          ...
          <Text style={styles.playerPercentage}>
            Percentage: {item.defenceAnalysisData?.defence_analysis_matching_percentage.overall?.toFixed(2) || 'N/A'}%
          </Text>
        </View>
      </View>
  ...
  return (
      <View style={styles.container}>
           <View style={styles.header}>
             ...
             <Text style={styles.headerText}>Defense Top Players</Text>
           </View>
